...
Reference:
https://github.com/chenz53/MIM-Med3D/blob/main/code/models/swin_3d.py
"""
...
class WindowAttention3D(nn.Module):
    ...
    def __init__(
        ...
        #)  # 3, Wd, Wh, Ww
        coords_d, coords_h, coords_w = torch.meshgrid(coords_d, coords_h, coords_w)
        coords = torch.stack([coords_d, coords_h, coords_w])
